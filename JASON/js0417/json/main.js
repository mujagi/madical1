$(function(){
    ...
    // 최초실행 -----------------------------------------------------------------------------------
        ...
        // 최초 데이터 불러오기
        $.ajax({
            url:"http://127.0.0.1:5500/JASON/js0417/json/stu_score.json",
            data:{},
            type:"get",
            dataType:"json",
    ...
    // 최초실행 -----------------------------------------------------------------------------------
        ...
        $("#writeBtn").click(function(){
            if($(".stuChk:checked").length>=1){
                alert("학생입력을 하시려면 체크를해제하셔야 가능합니다.\n자동 체크해제를 하겠습니다.");
                //체크모두해제
        ...
        $("#modifyBtn").click(function(){
            console.log("체크박스 개수 : "+$(".stuChk:checked").length);
            //1명만 선택
            if($(".stuChk:checked").length !=1){
        ...
        $("#deleteBtn").click(function(){
            ...
            if(!confirm("정말 삭제하시겠습니까?")){
                return false; // no 버튼 클릭 시 다시 돌아감.
            } // 삭제 if
            //모든 체크박스를 가져오기
            $(".stuChk").each(function(){
